  ...
  container_definitions = jsonencode([
    {
      ...
      environment = concat([
        ...
        { name = "DDB_TABLE_TOKENS", value = local.ddb_table_tokens },
        { name = "DDB_TABLE_SESSIONS", value = local.ddb_table_sessions },
        { name = "DDB_TABLE_DELTA", value = local.ddb_table_delta },
        { name = "DDB_TABLE_IDEMPOTENCY", value = local.ddb_table_idempotency },
